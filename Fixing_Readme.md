...
# 1. Download and install Protobuf 32 and Jansson 4 (Version >= 2.14)
wget http://ftp.de.debian.org/debian/pool/main/p/protobuf/libprotobuf32_3.21.12-3+deb12u1_amd64.deb
wget http://ftp.de.debian.org/debian/pool/main/j/jansson/libjansson4_2.14-2_amd64.deb
sudo dpkg -i libprotobuf32_3.21.12-3+deb12u1_amd64.deb libjansson4_2.14-2_amd64.deb

sudo dpkg -i --force-overwrite libboost-serialization*.deb
